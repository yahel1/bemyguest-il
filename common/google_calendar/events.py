...
from common.google_calendar.general import _find_closest_color_id_in_gc
from common.outlook_reader.constants import BUSY, ELSEWHERE, OUT_OF_OFFICE, TENTATIVE
from common.outlook_reader.outlook_event import OutlookCalendarEntry
